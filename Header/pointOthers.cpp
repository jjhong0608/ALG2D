...
ALG::boundaryPoint::boundaryPoint(char condition, char io, double boundaryValue) : condition(condition), IO(io), boundary_value(boundaryValue) {}

ALG::boundaryPoint::boundaryPoint(char condition, char io, double boundaryValue, ALG::boundaryLine2D *line) : condition(condition), IO(io), boundary_value(boundaryValue), line(line) {}

ALG::boundaryPoint::boundaryPoint(char condition, char io, double boundaryValue, ALG::boundaryLine2D *line, const ALG::vector &normal) : condition(condition), IO(io), boundary_value(boundaryValue), line(line), normal(normal) {}
...
ALG::boundaryPoint::boundaryPoint(const std::vector<double> &x, char condition, char io, double boundaryValue) : point(x), condition(condition), IO(io), boundary_value(boundaryValue) {}

ALG::boundaryPoint::boundaryPoint(const std::vector<double> &x, char condition, char io, double boundaryValue, ALG::boundaryLine2D *line) : point(x), condition(condition), IO(io), boundary_value(boundaryValue), line(line) {}

ALG::boundaryPoint::boundaryPoint(const std::vector<double> &x, char condition, char io, double boundaryValue, ALG::boundaryLine2D *line, const ALG::vector &normal) : point(x), condition(condition), IO(io), boundary_value(boundaryValue), line(line), normal(normal) {}
